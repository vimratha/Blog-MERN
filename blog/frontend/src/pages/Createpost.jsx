  ...
  return (
    <div>
      ...
      <div className="px-6 md:px-[200px] mt-8">
        <h1 className="font-bold md:text-2xl text-xl mt-8 ml-3 pb-5">Create a Post</h1>
        ...
        <div className="flex flex-col">
          ...
          {cats.map((item,i)=>(
            ...
            <button onClick={handlecreate} className="bg-black w-full mx-auto text-white font-semibold px-4 py-2 md:text-xl ">Create</button>
        </form>
      </div>
      <Footer/>
    </div>
